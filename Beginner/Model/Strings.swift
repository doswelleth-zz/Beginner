...
struct ArrayStrings {
    let array = [
        ...
        ["BitGo", "Bread", "Green Address", "Mycelium"],
        ...
        ["Coin Center"],
        ["Andreas Antonopoulos", "Off Chain with Jimmy Song", "The Bitcoin News Show"]
    ]
}
...
struct DetailArrayStrings {
    let detailArray = [
        ...
        ["Hunter S. Thompson-style retelling of Bitcoin's early days", "Foundational book on getting started with Bitcoin", "Two smart journalists cover Bitcoin around the world", "The economics of Bitcoin deftly explained", "Andreas Antonopoulos delves into the why of Bitcoin"],
        ["Hardware wallet founded by a Bitcoin Core developer", "Well-designed hardware wallet for your home computer", "Stylish and multi-currency alternative for hardware wallets", "Cyberpunk Bitcoin bearer instrument on a USB stick", "The original & most secure hardware wallet"],
        ...
        ["Clean multi-signature Segwit wallet ", "Hip starter wallet for non-technical users", "Preferred Segwit wallet for security-conscious users", "Sleek and secure user-friendly wallet for iOS"],
        ["Stylish, well-produced podcast in a three-part series", "Technical podcast on economics and monetary policy", "Long-running podcast on the Bitcoin ecosystem", " A Forbes contributor interviews the Bitcoin community"],
        ...
        ["World-renowned Bitcoin educator, author and activist", "Daily news show hosted by Jimmy Song and Tone Vays", "Weekly cypherpunk hangout with special guests"]
    ]
}
